...
Route::get('/student/payment/details/', 'StudentAskQuestionController@viewPaymentDetails')->name('student-view-payments');
//files
...
//student routes
Route::get('/student/get/all', 'StudentQuestionController@getAllQuestions')->name('student-view-questions');
Route::get('/student/get/det/{questionid}', 'StudentQuestionController@viewQuestionDetails')->name('student-question-det');
Route::post('/student/assign/{questionid}', 'QuestionDetailController@assignBids')->name('assign-questions');
//paypal routes
